...
<div class="max-w-5xl mx-auto">
    ...
    <div class="bg-white shadow-xl rounded-3xl border border-slate-200 overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-blue-500 to-blue-700 p-6 text-white">
            <h2 class="text-2xl font-bold">Edit Supplier Details</h2>
            <p class="text-sm opacity-90">Update supplier information and contact details</p>
        </div>

        <!-- Form Section -->
        <form method="POST" action="{{ route('inventory.suppliers.update', $supplier) }}" class="p-8 space-y-8">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="supplier_type"
                        ...
                        <option value="regular" {{ old('supplier_type', $supplier->supplier_type)=='regular'?'selected':'' }}>Regular</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select name="business_account"
                        ...
                        @foreach($businesses as $business)
                            <option value="{{ $business->id }}" {{ old('business_account', $supplier->business_account) == $business->id ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <input name="vat_number" value="{{ old('vat_number', $supplier->vat_number) }}"
                ...
                <div>
                    ...
                    <input name="pan_number" value="{{ old('pan_number', $supplier->pan_number) }}"
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="address" rows="3"
                              ...
                              class="mt-1 w-full rounded-xl border-slate-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm px-4 py-2.5">{{ old('address', $supplier->address) }}</textarea>
                </div>
