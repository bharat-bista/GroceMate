        ...
        <section class="auth-shell">
            <aside class="brand-panel">
                <div class="brand-top">
                    ...
                    <p class="brand-subtitle">Create a fresh password and get back into your GroceMate account securely.</p>
                    <div class="logo-showcase">
                        <div class="logo-card">
                            <img src="{{ asset('assets/img/logo/logo.png') }}" alt="GroceMate logo" class="logo-image">
                        </div>
                        <p class="logo-caption">Use a strong password to protect both your business workflow and customer account access.</p>
                    </div>
                </div>
            ...
            <section class="form-panel">
                <div class="form-card">
                    ...
                    <p class="welcome-subtitle">Set your new password below and sign back in once the reset is complete.</p>
                    <div class="alerts">
                        @if($errors->any())
                    ...
                    <form action="{{ route('password.reset') }}" method="POST" class="auth-form">
                        ...
                        <div class="field">
                            ...
                            <input type="password" name="password" id="password" placeholder="New password" class="@error('password') is-invalid @enderror" required autofocus>
                            @error('password')
