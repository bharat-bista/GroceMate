        ...
        <section class="auth-shell">
            <aside class="brand-panel">
                <div class="brand-top">
                    ...
                    <p class="brand-subtitle">Recover access securely and continue using your GroceMate account without losing your workflow.</p>

                    <div class="logo-showcase">
                        <div class="logo-card">
                            <img src="{{ asset('assets/img/logo/logo.png') }}" alt="GroceMate logo" class="logo-image">
                        </div>
                        <p class="logo-caption">We will send a one-time code to your email so you can reset your password safely.</p>
                    </div>
                </div>
            ...
            <section class="form-panel">
                <div class="form-card">
                    ...
                    <p class="welcome-subtitle">Enter your email address and we will send you an OTP to continue resetting your password.</p>
                    ...
                    <form action="{{ route('password.sendOtp') }}" method="POST" class="auth-form">
                        @csrf
                        <div class="field">
                            <label for="email">Email address</label>
                            <input type="email" name="email" id="email" placeholder="Email address" value="{{ old('email') }}" class="@error('email') is-invalid @enderror" required autofocus>
                            @error('email')
                    ...
                    <p class="footer-text"><a href="{{ route('page-login') }}">Back to login</a></p>
                </div>
            </section>
        </section>
    </main>
